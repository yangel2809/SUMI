    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entry_element', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='entry_element', to='essays.entryelement')),
            ...
            options={
                ...
                'permissions': [('view_working_ArtRequest', 'Puede firmar una solicitud de prueba cómo revisada'), ('sign_ArtRequest', 'Puede firmar una solicitud de prueba cómo revisada'), ('view_archived_ArtRequest', 'Puede ver el archivo de solicitudes de prueba'), ('archive_ArtRequest', 'Puede archivar una solicitud de prueba'), ('unarchive_ArtRequest', 'Puede desarchivar una solicitud de prueba'), ('view_deleted_ArtRequest', 'Puede ver la papelera de solicitudes de prueba'), ('delete_true_ArtRequest', 'Puede eliminar permanentemenete una solicitud de prueba'), ('restore_ArtRequest', 'Puede restaurar una solicitud de prueba de la papelera'), ('close_ArtRequest', 'Puede Cerrar Un expediente de Pruebas y enviar a IDAT'), ('open_ArtRequest', 'Puede Abrir Un expediente de Pruebas y enviar a IDAT')],
            },
        ),
        ...
        migrations.AlterField(
            ...
            name='test_request',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='exit_element', to='essays.artrequest', verbose_name='Solicitud de prueba'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='historicaltechnicalspecs',
            name='test_request',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='essays.artrequest'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='test_request',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='essays.artrequest'),
        ),
        migrations.AlterField(
            model_name='teststructure',
            name='test_request',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='essays.artrequest'),
        ),
        migrations.CreateModel(
